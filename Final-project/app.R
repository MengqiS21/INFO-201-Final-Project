             ...
             tabPanel(
               ...
               fluidPage(
                 img(src = "https://www.heart.org/-/media/Healthy-Living-Images/Healthy-Lifestyle/Pets/puppy-kitten-heart.jpg", 
                         ...
                         p(h4(strong("Welcome to our Seattle Pet Licenses app!", style = "color:green"))),
                         ...
                         p("- We decided to work with the pet licensing data, to inform Seattleites on pet ownership trends and encouraged the people of Seattle to adopt unlicensed pets at the animal shelters."),
